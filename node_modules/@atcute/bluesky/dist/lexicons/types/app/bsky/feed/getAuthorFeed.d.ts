...
declare const _mainSchema: v.XRPCQueryMetadata<v.ObjectSchema<{
     ...
     */
    filter: v.OptionalSchema<v.StringSchema<"posts_and_author_threads" | "posts_no_replies" | "posts_with_media" | "posts_with_replies" | "posts_with_video" | (string & {})>, "posts_with_replies">;
    /** @default false */
    includePins: v.OptionalSchema<v.BooleanSchema, false>;
    /**
     * @default 50
     * @minimum 1
     * @maximum 100
    ...
    schema: v.ObjectSchema<{
        cursor: v.OptionalSchema<v.StringSchema<string>, undefined>;
        readonly feed: v.ArraySchema<AppBskyFeedDefs.feedViewPostSchema>;
    }>;
