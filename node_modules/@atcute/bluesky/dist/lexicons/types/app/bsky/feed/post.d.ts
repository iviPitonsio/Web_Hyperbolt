...
declare const _mainSchema: v.RecordSchema<v.ObjectSchema<{
    ...
    readonly embed: v.OptionalSchema<v.VariantSchema<readonly [AppBskyEmbedExternal.mainSchema, AppBskyEmbedGallery.mainSchema, AppBskyEmbedImages.mainSchema, AppBskyEmbedRecord.mainSchema, AppBskyEmbedRecordWithMedia.mainSchema, AppBskyEmbedVideo.mainSchema], boolean>, undefined>;
    /**
