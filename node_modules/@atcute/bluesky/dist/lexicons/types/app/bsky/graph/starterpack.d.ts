...
declare const _feedItemSchema: v.ObjectSchema<{
    $type: v.OptionalSchema<v.LiteralSchema<"app.bsky.graph.starterpack#feedItem">, undefined>;
...
export declare const feedItemSchema: feedItemSchema;
