...
declare const _draftSchema: v.ObjectSchema<{
     ...
     * @maxLength 100
     */
    deviceId: v.OptionalSchema<v.SchemaWithConstraint<v.StringSchema<string>, readonly [v.StringLengthConstraint<0, 100>]>, undefined>;
    /**
     * The device and/or platform on which the draft was created.
     *
     * @maxLength 100
     */
    deviceName: v.OptionalSchema<v.SchemaWithConstraint<v.StringSchema<string>, readonly [v.StringLengthConstraint<0, 100>]>, undefined>;
    /**
...
declare const _draftEmbedGallerySchema: v.ObjectSchema<{
    $type: v.OptionalSchema<v.LiteralSchema<"app.bsky.draft.defs#draftEmbedGallery">, undefined>;
    readonly items: draftEmbedGalleryItemsSchema;
}>;
declare const _draftEmbedGalleryItemsSchema: v.SchemaWithConstraint<v.ArraySchema<v.VariantSchema<readonly [draftEmbedImageSchema], boolean>>, readonly [v.ArrayLengthConstraint<0, 20>]>;
...
declare const _draftPostSchema: v.ObjectSchema<{
    ...
    readonly embedGallery: v.OptionalSchema<draftEmbedGallerySchema, undefined>;
    /** @maxLength 4 */
...
export declare const draftEmbedGallerySchema: draftEmbedGallerySchema;
export declare const draftEmbedGalleryItemsSchema: draftEmbedGalleryItemsSchema;
