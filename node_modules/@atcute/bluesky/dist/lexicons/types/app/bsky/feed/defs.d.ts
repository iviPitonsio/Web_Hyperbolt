...
declare const _generatorViewSchema: v.ObjectSchema<{
    ...
    contentMode: v.OptionalSchema<v.StringSchema<"app.bsky.feed.defs#contentModeUnspecified" | "app.bsky.feed.defs#contentModeVideo" | (string & {})>, undefined>;
...
declare const _interactionSchema: v.ObjectSchema<{
    ...
    event: v.OptionalSchema<v.StringSchema<"app.bsky.feed.defs#clickthroughAuthor" | "app.bsky.feed.defs#clickthroughEmbed" | "app.bsky.feed.defs#clickthroughItem" | "app.bsky.feed.defs#clickthroughReposter" | "app.bsky.feed.defs#interactionLike" | "app.bsky.feed.defs#interactionQuote" | "app.bsky.feed.defs#interactionReply" | "app.bsky.feed.defs#interactionRepost" | "app.bsky.feed.defs#interactionSeen" | "app.bsky.feed.defs#interactionShare" | "app.bsky.feed.defs#requestLess" | "app.bsky.feed.defs#requestMore" | (string & {})>, undefined>;
    /**
...
declare const _postViewSchema: v.ObjectSchema<{
    ...
    readonly embed: v.OptionalSchema<v.VariantSchema<readonly [AppBskyEmbedExternal.viewSchema, AppBskyEmbedGallery.viewSchema, AppBskyEmbedImages.viewSchema, AppBskyEmbedRecord.viewSchema, AppBskyEmbedRecordWithMedia.viewSchema, AppBskyEmbedVideo.viewSchema], boolean>, undefined>;
    indexedAt: v.FormattedStringSchema<"datetime">;
    readonly labels: v.OptionalSchema<v.ArraySchema<ComAtprotoLabelDefs.labelSchema>, undefined>;
    likeCount: v.OptionalSchema<v.IntegerSchema, undefined>;
