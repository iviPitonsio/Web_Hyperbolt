...
declare const _viewRecordSchema: v.ObjectSchema<{
    ...
    readonly embeds: v.OptionalSchema<v.ArraySchema<v.VariantSchema<readonly [AppBskyEmbedExternal.viewSchema, AppBskyEmbedGallery.viewSchema, AppBskyEmbedImages.viewSchema, viewSchema, AppBskyEmbedRecordWithMedia.viewSchema, AppBskyEmbedVideo.viewSchema], boolean>>, undefined>;
