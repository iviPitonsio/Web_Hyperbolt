...
declare const _mainSchema: v.ObjectSchema<{
    ...
    readonly media: v.VariantSchema<readonly [AppBskyEmbedExternal.mainSchema, AppBskyEmbedGallery.mainSchema, AppBskyEmbedImages.mainSchema, AppBskyEmbedVideo.mainSchema], boolean>;
...
declare const _viewSchema: v.ObjectSchema<{
    ...
    readonly media: v.VariantSchema<readonly [AppBskyEmbedExternal.viewSchema, AppBskyEmbedGallery.viewSchema, AppBskyEmbedImages.viewSchema, AppBskyEmbedVideo.viewSchema], boolean>;
