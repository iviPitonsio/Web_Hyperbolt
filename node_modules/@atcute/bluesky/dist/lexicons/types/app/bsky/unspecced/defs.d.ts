...
declare const _ageAssuranceEventSchema: v.ObjectSchema<{
    ...
    status: v.StringSchema<"assured" | "pending" | "unknown" | (string & {})>;
}>;
...
declare const _skeletonTrendSchema: v.ObjectSchema<{
    ...
    status: v.OptionalSchema<v.StringSchema<"hot" | (string & {})>, undefined>;
...
declare const _threadItemPostSchema: v.ObjectSchema<{
     ...
     */
    opThreadPostCount: v.OptionalSchema<v.IntegerSchema, undefined>;
    /**
     ...
     */
    opThreadPostIndex: v.OptionalSchema<v.IntegerSchema, undefined>;
