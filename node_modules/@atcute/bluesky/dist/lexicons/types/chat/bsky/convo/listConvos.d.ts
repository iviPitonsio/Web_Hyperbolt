...
declare const _mainSchema: v.XRPCQueryMetadata<v.ObjectSchema<{
    ...
    kind: v.OptionalSchema<v.StringSchema<"direct" | "group" | (string & {})>, undefined>;
    /**
     * @default 50
     * @minimum 1
     * @maximum 100
    ...
    lockStatus: v.OptionalSchema<v.StringSchema<"locked" | "locked-permanently" | "unlocked" | (string & {})>, undefined>;
    readState: v.OptionalSchema<v.StringSchema<"unread" | (string & {})>, undefined>;
    /**
    ...
    schema: v.ObjectSchema<{
        readonly convos: v.ArraySchema<ChatBskyConvoDefs.convoViewSchema>;
        cursor: v.OptionalSchema<v.StringSchema<string>, undefined>;
    }>;
