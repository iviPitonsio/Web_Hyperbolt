...
declare const _convoRefSchema: v.ObjectSchema<{
    $type: v.OptionalSchema<v.LiteralSchema<"chat.bsky.convo.defs#convoRef">, undefined>;
...
declare const _groupConvoSchema: v.ObjectSchema<{
     ...
     * at 21.
     */
    joinRequestCount: v.OptionalSchema<v.IntegerSchema, undefined>;
     ...
     */
    lockStatusModerationOverride: v.BooleanSchema;
    /** The total number of members in the group conversation. */
    memberCount: v.IntegerSchema;
    /** The maximum number of members allowed in the group conversation. */
    memberLimit: v.IntegerSchema;
    /**
     ...
     * @maxGraphemes 50
     */
    name: v.SchemaWithConstraint<v.StringSchema<string>, readonly [v.StringLengthConstraint<0, 500>, v.StringGraphemesConstraint<0, 50>]>;
    /** The number of unread join requests for the group conversation. Only present for the owner. */
    unreadJoinRequestCount: v.OptionalSchema<v.IntegerSchema, undefined>;
}>;
...
declare const _logAddMemberSchema: v.ObjectSchema<{
    ...
    readonly message: systemMessageViewSchema;
    /** Profiles referred in the system message. */
    readonly relatedProfiles: v.ArraySchema<ChatBskyActorDefs.profileViewBasicSchema>;
    rev: v.StringSchema<string>;
}>;
declare const _logAddReactionSchema: v.ObjectSchema<{
     ...
     */
    readonly relatedProfiles: v.OptionalSchema<v.ArraySchema<ChatBskyActorDefs.profileViewBasicSchema>, undefined>;
    rev: v.StringSchema<string>;
}>;
...
declare const _logReadJoinRequestsSchema: v.ObjectSchema<{
    $type: v.OptionalSchema<v.LiteralSchema<"chat.bsky.convo.defs#logReadJoinRequests">, undefined>;
    convoId: v.StringSchema<string>;
    rev: v.StringSchema<string>;
}>;
...
declare const _logWithdrawIncomingJoinRequestSchema: v.ObjectSchema<{
    $type: v.OptionalSchema<v.LiteralSchema<"chat.bsky.convo.defs#logWithdrawIncomingJoinRequest">, undefined>;
    convoId: v.StringSchema<string>;
    /** Prospective member who withdrew their join request. */
    readonly member: ChatBskyActorDefs.profileViewBasicSchema;
    rev: v.StringSchema<string>;
}>;
declare const _logWithdrawOutgoingJoinRequestSchema: v.ObjectSchema<{
    $type: v.OptionalSchema<v.LiteralSchema<"chat.bsky.convo.defs#logWithdrawOutgoingJoinRequest">, undefined>;
    convoId: v.StringSchema<string>;
    rev: v.StringSchema<string>;
}>;
...
declare const _messageBeforeUserJoinedGroupViewSchema: v.ObjectSchema<{
    $type: v.OptionalSchema<v.LiteralSchema<"chat.bsky.convo.defs#messageBeforeUserJoinedGroupView">, undefined>;
}>;
declare const _messageInputSchema: v.ObjectSchema<{
    ...
    readonly embed: v.OptionalSchema<v.VariantSchema<readonly [AppBskyEmbedRecord.mainSchema, ChatBskyEmbedJoinLink.mainSchema], boolean>, undefined>;
    ...
    readonly replyTo: v.OptionalSchema<replyRefSchema, undefined>;
    /**
     * @maxLength 10000
     * @maxGraphemes 1000
     */
...
declare const _messageViewSchema: v.ObjectSchema<{
    ...
    readonly embed: v.OptionalSchema<v.VariantSchema<readonly [AppBskyEmbedRecord.viewSchema, ChatBskyEmbedJoinLink.viewSchema], boolean>, undefined>;
    /** Annotations of text (mentions, URLs, hashtags, etc) */
    readonly facets: v.OptionalSchema<v.ArraySchema<AppBskyRichtextFacet.mainSchema>, undefined>;
    id: v.StringSchema<string>;
     ...
     */
    readonly replyTo: v.OptionalSchema<v.VariantSchema<readonly [deletedMessageViewSchema, messageBeforeUserJoinedGroupViewSchema, messageViewSchema], boolean>, undefined>;
    rev: v.StringSchema<string>;
    readonly sender: messageViewSenderSchema;
    sentAt: v.FormattedStringSchema<"datetime">;
    /**
...
declare const _replyRefSchema: v.ObjectSchema<{
    $type: v.OptionalSchema<v.LiteralSchema<"chat.bsky.convo.defs#replyRef">, undefined>;
    messageId: v.StringSchema<string>;
}>;
declare const _systemMessageDataAddMemberSchema: v.ObjectSchema<{
    ...
    readonly addedBy: systemMessageReferredUserSchema;
    /** Current view of the member who was added. */
    readonly member: systemMessageReferredUserSchema;
    /**
...
declare const _systemMessageDataLockConvoSchema: v.ObjectSchema<{
    ...
    readonly lockedBy: systemMessageReferredUserSchema;
}>;
...
declare const _systemMessageDataMemberJoinSchema: v.ObjectSchema<{
     ...
     */
    readonly approvedBy: v.OptionalSchema<systemMessageReferredUserSchema, undefined>;
...
declare const _systemMessageDataRemoveMemberSchema: v.ObjectSchema<{
    ...
    readonly member: systemMessageReferredUserSchema;
    readonly removedBy: systemMessageReferredUserSchema;
}>;
declare const _systemMessageDataUnlockConvoSchema: v.ObjectSchema<{
    ...
    readonly unlockedBy: systemMessageReferredUserSchema;
}>;
declare const _systemMessageReferredUserSchema: v.ObjectSchema<{
    $type: v.OptionalSchema<v.LiteralSchema<"chat.bsky.convo.defs#systemMessageReferredUser">, undefined>;
    did: v.FormattedStringSchema<"did">;
}>;
...
export declare const convoRefSchema: convoRefSchema;
...
export declare const logReadJoinRequestsSchema: logReadJoinRequestsSchema;
...
export declare const logWithdrawIncomingJoinRequestSchema: logWithdrawIncomingJoinRequestSchema;
export declare const logWithdrawOutgoingJoinRequestSchema: logWithdrawOutgoingJoinRequestSchema;
export declare const messageAndReactionViewSchema: messageAndReactionViewSchema;
export declare const messageBeforeUserJoinedGroupViewSchema: messageBeforeUserJoinedGroupViewSchema;
...
export declare const systemMessageReferredUserSchema: systemMessageReferredUserSchema;
...
export interface LogWithdrawIncomingJoinRequest extends v.InferInput<typeof logWithdrawIncomingJoinRequestSchema> {
}
export interface LogWithdrawOutgoingJoinRequest extends v.InferInput<typeof logWithdrawOutgoingJoinRequestSchema> {
}
export interface MessageAndReactionView extends v.InferInput<typeof messageAndReactionViewSchema> {
}
export interface MessageBeforeUserJoinedGroupView extends v.InferInput<typeof messageBeforeUserJoinedGroupViewSchema> {
}
