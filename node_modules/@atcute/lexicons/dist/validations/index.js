...
// #__NO_SIDE_EFFECTS__
export const is = (schema, input, options) => {
...
// #__NO_SIDE_EFFECTS__
export const safeParse = (schema, input, options) => {
...
export const parse = (schema, input, options) => {
    let flags = FLAG_EMPTY;
    if (options?.strict) {
        flags |= FLAG_STRICT;
    }
...
// #__NO_SIDE_EFFECTS__
export const blobAccept = (accept) => {
