...
export declare const parseResourceUri: (input: string) => ParsedResourceUri;
/**
...
export declare const parseCanonicalResourceUri: (input: string) => ParsedCanonicalResourceUri;
